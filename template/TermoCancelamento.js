...
const S = StyleSheet.create({
  page:        { fontFamily: 'Arial', fontSize: 12, paddingTop: 20, paddingBottom: 80, paddingLeft: 72, paddingRight: 72 },
  ...
  headerNome:  { fontFamily: 'Arial', fontWeight: 'bold', fontSize: 11, textAlign: 'center', marginBottom: 2 },
  headerInfo:  { fontSize: 9, textAlign: 'center', color: '#444', marginBottom: 1 },

  title:       { fontFamily: 'Arial', fontWeight: 'bold', fontSize: 13, textAlign: 'center', textDecoration: 'underline', marginTop: 32, marginBottom: 32 },
  ...
  dateValue:   { fontFamily: 'Arial', fontWeight: 'bold', fontSize: 14 },
